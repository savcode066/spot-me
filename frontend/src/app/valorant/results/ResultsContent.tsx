...
const NO_MATCH_TIPS = [
  "Check the ID and tag — Riot IDs are region-specific and case-sensitive after the #.",
  "The streamer may have played on a different account than their main.",
  "Only VODs still on the channel can be searched — Twitch drops them after 60 days.",
];
